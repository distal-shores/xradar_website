...
get_header(); ?>
    ...
    <div id="primary" class="content-area">
        <main id="main" class="page-about" role="main">
            ...
            <section id="overview">
                <div class="white-box">
                    <h1>The most advanced GPR technology in the industry</h1>
                </div>
                <hr>
                <div class="two-column">
                    <p>
                        <strong>
                            X-Radar is Canada’s leading provider of ground penetrating radar (GPR) technology, providing scanning services with our custom Xradar equipment. This newly designed technology has been developed specifically for scanning concrete, and has the accuracy of x-ray with the safety and efficiency of GPR.
                        </strong>
                    </p>
                    <p>
            ...
            <section id="why-xradar">
                ...
                <div class="three-column">
                    <div class="column">
                        <img src="http://xradar.dev/wp-content/uploads/2017/07/Trophy@1x.png"/>
                        <h3>Industry Leader</h3>
                        <hr>
                        <p>Xradar is the leading provider of GPR and concrete scanning services in Canada. All of our technicians have undergone extensive proprietary training and are significantly experienced in the application of Xradar. We deliver to the highest industry standards and ensure the best results for our clients.</p>
                    </div>
                    <div class="column">
                        <img src="http://xradar.dev/wp-content/uploads/2017/07/System-@1x.png"/>
                        <h3>Advanced System</h3>
                        <hr>
                        <p>We have developed the most advanced GPR technology in the form of Xradar, providing the accuracy of x-ray, with the safety and efficiency of GPR.</p>
                    </div>
                    <div class="column">
                        <img src="http://xradar.dev/wp-content/uploads/2017/07/Shape@1x.png"/>
                        <h3>Nationwide</h3>
                        <hr>
                        <p>We have offices all over Canada, including Victoria, Vancouver, Toronto, Montreal and Quebec, with more offices to be opened, meaning we are positioned to serve your needs wherever you are located.</p>
                    </div>
                </div>
            </section>
            ...
            <section id="methods">
                <div class="method-explanation">
                    <div class="white-box">
                        ...
                        <hr>
                        <p class="feature">
                            We use our own bespoke Xradar technology, a form of ground penetrating radar (GPR) to carry out scanning services across a huge range of applications.
                        </p>
                    </div>
                    <div class="picture">
                        <div class="content">
                            <h3>What is Ground Penetrating Radar?</h3>
                            <hr>
                            <p>
                        ...
                        <div class="methods-photo hard-hat"></div>
                    </div>
                    <div class="picture left">
                        <div class="methods-photo closeup"></div>
                        <div class="content">
                            <h3>The Process</h3>
                            <hr>
                            <p>
                                Xradar’s system consists of a transmitter, a receiver, and a control unit. The transmitting antenna begins by sending electromagnetic waves into the ground, which are then reflected off underground layers and objects.
                            </p>
                            <p>
                    ...
                    <div class="picture">
                        <div class="content">
                            ...
                            <hr>
                            <p>
                                Xradar has applications in a number of fields. It can be used in earth sciences to study bedrock, soils and groundwater, along with water table profiling.
                            </p>
                            <p>
                        ...
                        <div class="methods-photo spray-paint"></div>
                    </div>
                </div>
            </section>
