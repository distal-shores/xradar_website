...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			if($(window).width() >= 767) {
				$('#hero-photo button, #hero-photo p').hide();
				$('#hero-photo h1').hide().fadeIn(1000, function() {
					$('#hero-photo p, #hero-photo button').fadeIn(750, function() {
						// $('#hero-photo button').fadeIn(750);
					});
				});
			}
		});
